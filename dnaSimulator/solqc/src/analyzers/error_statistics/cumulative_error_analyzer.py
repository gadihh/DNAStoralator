...
def plot_errornumcount(x_labels, y_values, graph_title='', x_title='', y_title='', x_title_fontsize=14, y_title_fontsize=14,
                       x_labels_fontsize=14, multigraph_labels=[''], bar_width=0.15, plot_format=['-o', 'b', 'r', 'y'],
    ...
    plt.xticks(list(reversed(list(reversed(index))[0::indexing_jump]))[0:maxxtick],
               ...
               rotation=0, fontsize=16)  # index + bar_width?

    plt.yticks(fontsize=16)
    plt.grid()
    plt.xlabel("Number of edit errors", fontsize=20)
...
def plot_errornumcount_with_long(x_labels, y_values, graph_title='', x_title='', y_title='', x_title_fontsize=14,
    ...
    plt.grid()
    plt.xlabel("Number of edit errors", fontsize=22)
    plt.ylabel("Fraction of reads", fontsize=22)
    # Save scatter as image
...
class CumulativeErrorAnalyzer(DeletionAnalyzer):
    ...
    def generate_content2(self, read_errors_count, len_matched_reads):
        ...
        headline = Content(Content.Type.TEXT, "Cummulative distrubtion based upon the number of edit error")
        ...
        content_array.append(Content(Content.Type.NEW_PAGE, ""))
        content_array.append(headline)
